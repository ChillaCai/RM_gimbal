...
void RC::ParseDbus() {
  ...
  this->channel_.r_row = LinearMappingInt2Float((int16_t)r_row_raw, 1024, 1684, 0.0f, 1.0f);
  this->channel_.r_col = LinearMappingInt2Float((int16_t)r_col_raw, 1024, 1684, 0.0f, 1.0f);
  this->channel_.l_row = LinearMappingInt2Float((int16_t)l_row_raw, 1024, 1684, 0.0f, 1.0f);
  this->channel_.l_col = LinearMappingInt2Float((int16_t)l_col_raw, 1024, 1684, 0.0f, 1.0f);
  // RCSwitch
